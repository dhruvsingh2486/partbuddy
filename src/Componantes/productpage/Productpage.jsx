...
function Productpage() {
  const allproducts = [
    ...
    },
    {
      ...
      title: "Trimmable Carbon Finish Lip Spoiler with Dual Adhesive Tape",
      price: "₹1,060.0",
      comp: "HONDA",
    },
    {
    ...
    },
    {
      ...
      title:
        "Universal Spoiler with Multifunctional Light (54 Inches, Carbon Finish)",
      price: "₹2,166.0",
      comp: "HONDA",
    },
    {
    ...
    },
    {
      ...
      title: "TAPE BLACK OUT QTR PANEL OTR LH",
      price: "₹573.00",
      comp: "HONDA",
    },
    {
  ...
  const { id } = useParams();
  const productpage = allproducts.find((product) => product.id === id);
  if (!productpage) {
      ...
      <div className="card mb-3 single_producte_mng">
        <div className="row g-0">
          ...
          <div className="col-md-8" style={{ marginTop: "6%" }}>
            <p className="brand" style={{ textTransform: "capitalize" }}>
              {productpage.comp}
              <span>
                <i class="fa-solid fa-truck delivery">
            ...
            <div className="card-body">
              <h3 className="card-title">{productpage.title}</h3>
              <h5>
                {productpage.price}{" "}
                <span style={{ fontSize: "14px" }}>incl. all taxes</span>
              </h5>
              <p className="card-text">
                <p>
                  Automotive tapes, also known as adhesive tapes, are versatile
                  tools used in the automotive industry for a variety of
                  purposes. They are used to hold parts together, protect
                  surfaces, and perform other tasks. Some types of automotive
                  tapes include
                </p>
