  ...
  const openproduct = (item) =>{
    navigate(`/Productpage/${item.id}`)
      ...
      <div style={{ justifyContent: "center", textAlign: "center" }}>
        <h1 className="text-shadow">Bearings</h1>
        <div>



        <div className="row" style={{ gap: "4vw", margin: "50px 20px" }}>
          <h3 className="text-shadow">Rear Wheel Bearings</h3>
        ...
        <div className="row" style={{ gap: "4vw", margin: "50px 20px" }}>
          <h3 className="text-shadow">Pilot Bearings</h3>
          {/* <div className='col-md-12'> */}
        ...
        <div className="row" style={{ gap: "4vw", margin: "50px 20px" }}>
          <h3 className="text-shadow">Shock Absorber Bearings</h3>
          {/* <div className='col-md-12'> */}
        ...
        <div className="row" style={{ gap: "4vw", margin: "50px 20px" }}>
          <h3 className="text-shadow">Transmission Bearings</h3>
          {/* <div className='col-md-12'> */}
...
<div className="row" style={{ gap: "4vw", margin: "50px 20px" }}>
  <h3 className="text-shadow">Alternator Bearings</h3>
  {/* <div className='col-md-12'> */}
...
<div className="row" style={{ gap: "4vw", margin: "50px 20px" }}>
  <h3 className="text-shadow">Bigend Bearings</h3>
  {/* <div className='col-md-12'> */}
...
<div className="row" style={{ gap: "4vw", margin: "50px 20px" }}>
  <h3 className="text-shadow">Clutch Bearings</h3>
  {/* <div className='col-md-12'> */}
...
<div className="row" style={{ gap: "4vw", margin: "50px 20px" }}>
  <h3 className="text-shadow">Cranck Bearings</h3>
  {/* <div className='col-md-12'> */}
